...
def main():
    ...
    parser.add_argument("--repo", default=".", help="FoldCraftLauncher repo root")
    ...
    parser.add_argument("--output", default="tools/mobilegl_trace_capture/out/egltrace.so")
    ...
    source_dir = repo / "tools" / "mobilegl_trace_capture" / "android_egltrace"
